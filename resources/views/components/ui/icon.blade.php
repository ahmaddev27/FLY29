@props([
    'name',                // edit | trash | plus | eye | eye-off | check | x | download | upload | search | filter | refresh | external
    'size' => 'md',        // sm | md | lg
])
...
@php
    ...
    // Heroicons outline-style paths (stroke-based, single-line).
    $paths = [
    ...
    // Special handling for "eye" which has 2 paths
    $isEye = $name === 'eye';
@endphp
